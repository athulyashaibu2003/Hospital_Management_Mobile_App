...
class _ReportsState extends State<Reports> {
  ...
  String calculateAge(SearchScreenController patientDataProvider) {
    String? date = patientDataProvider.searchModel.list?[0].dob;
  ...
  Widget build(BuildContext context) {
    ...
    var patientDataProvider = Provider.of<SearchScreenController>(context);
    return Scaffold(
      appBar: AppBar(
        backgroundColor: ColorConstants.mainBlue,
        title: Text(
            ...
            children: [
              ...
              buildActionTextField(
                ...
                onChanged: (value) async {
                  await patientDataFunctionProvider.searchModel.list?[0].pid ??
                      '';

                  if (patientDataFunctionProvider.searchModel.list?.length !=
                      0) {
                    setState(() {
                      firstName = patientDataFunctionProvider
                              .searchModel.list?[0].fname ??
                          "";
                      lastName = patientDataFunctionProvider
                              .searchModel.list?[0].lname ??
                          "";
                      nameController.text = firstName! + ' ' + lastName!;
                      ageController.text = calculateAge(patientDataProvider);
                      sexController.text = patientDataFunctionProvider
                              .searchModel.list?[0].gender ??
                          "";
                      bloodController.text = patientDataFunctionProvider
                              .searchModel.list?[0].bldgrp ??
                          "";
                      addressController.text = patientDataFunctionProvider
                              .searchModel.list?[0].address ??
                          "";
                      mobileController.text = patientDataFunctionProvider
                              .searchModel.list?[0].mob ??
                          "";
                      emailController.text = patientDataFunctionProvider
                              .searchModel.list?[0].email ??
                          "";
                      relTypeController.text = patientDataFunctionProvider
                              .searchModel.list?[0].reltype ??
                          "";
                      relContactController.text = patientDataFunctionProvider
              ...
              // ----------------------------------------------------------------------------------------------
              patientEmrView(
                  visibility: ipVisible, patientDetails: ipPatientDetails),
              patientEmrView(
                  visibility: opVisible, patientDetails: opPatientDetails),
              patientEmrView(
