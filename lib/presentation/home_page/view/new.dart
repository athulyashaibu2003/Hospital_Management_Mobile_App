...
//
  ...
  callFuction() async {
    await Provider.of<NewController>(context, listen: false).department();
  }
  ...
  Widget build(BuildContext context) {
    ...
    var functionprovider = Provider.of<NewController>(context, listen: false);
    var varprovider = Provider.of<NewController>(context);
