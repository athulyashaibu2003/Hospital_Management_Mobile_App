...
class ColorConstants {
  ...
  static const Color mainLightBlue = Color.fromARGB(255, 133, 206, 202);
  ...
  static const Color lightgreen = Color(0xFF80cbc4);
  static const Color lightlightgreen = Color(0x3006a1a0);
}
